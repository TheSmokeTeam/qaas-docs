...
- **Plugin architecture** - load [QaaS.Common.Processors](../processors/index.md) and [QaaS.Common.Generators](../generators/index.md) from the project itself, local assemblies, or NuGet packages.
