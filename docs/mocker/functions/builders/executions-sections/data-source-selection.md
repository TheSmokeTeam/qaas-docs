---
id: mocker.functions.builders.executions-sections.data-source-selection
type: reference
status: stable
since: 2.0.0
last_verified: 2026-05-22
applies_to: [mocker]
keywords: [mocker, functions, builders, executions, sections, data]
summary: "This page mirrors the Data source selection section from Executions."
---
