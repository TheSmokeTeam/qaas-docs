...
applies_to: [mocker]
keywords: [mocker, functions, builders, executions, sections, output, selection]
summary: "Reference page for Executions: Output selection."
---
<!-- Verified-against: QaaS.Mocker\QaaS.Mocker\ExecutionBuilder.cs -->

# Executions: Output selection

> TL;DR — Reference page for Executions: Output selection.
