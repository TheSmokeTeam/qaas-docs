---
id: mocker.functions.builders.transaction.stubs.sections.collection.helpers
type: reference
status: stable
since: 2.0.0
last_verified: 2026-05-22
applies_to: [mocker]
keywords: [mocker, functions, builders, transaction, stubs, sections, collection, helpers]
summary: "Reference page for Transaction Stubs: Collection helpers."
---
...
> TL;DR — Reference page for Transaction Stubs: Collection helpers.
