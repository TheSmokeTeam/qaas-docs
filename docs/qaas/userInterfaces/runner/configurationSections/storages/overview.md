...
summary: "The Storages section contains external storage definitions that QaaS runtime objects can be stored in or retrieved from when using the qaas act or qaas assert commands."
---
# Storages
