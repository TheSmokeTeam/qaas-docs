...
summary: "Assertions validate Runner session data after act-phase work and write assertion results to Allure output."
---
...
## Assertion Links {: #assertion-links}
...
## Assertion Result Details {: #assertion-result-details}
...
## Assertion Attachments {: #assertion-attachments}
...
- [Available assertions](../../../../../assertions/index.md)
