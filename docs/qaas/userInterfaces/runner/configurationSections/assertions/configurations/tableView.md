---
id: qaas.userinterfaces.runner.configurationsections.assertions.configurations.tableview
type: reference
status: stable
since: 2.0.0
...
summary: "Assertions Configurations Table View"
---
...
| `Assertions[].Links[].Grafana.Variables[].Key` | `string` | &#10004 |  |  |
| `Assertions[].Links[].Grafana.Variables[].Value` | `string` | &#10004 |  |  |
