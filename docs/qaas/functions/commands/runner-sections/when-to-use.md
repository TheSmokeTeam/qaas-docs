---
id: qaas.functions.commands.runner.sections.when.to.use
type: reference
status: stable
since: 2.0.0
...
summary: "Reference page for Runner: When to use."
---
<!-- Verified-against: QaaS.Runner\QaaS.Runner\Runner.cs -->

# Runner: When to use

> TL;DR — Reference page for Runner: When to use.

This page mirrors the `When to use` section from [Runner](../runner.md).
...
## `RunAndGetExitCode` {: #runandgetexitcode}
