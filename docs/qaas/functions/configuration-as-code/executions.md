<!-- generated hash:9e08e087d4de sources:Runner, functions, Configuration as Code, Executions -->

# Executions

Source-driven reference for `Runner` functions in the `Configuration as Code / Executions` category.
