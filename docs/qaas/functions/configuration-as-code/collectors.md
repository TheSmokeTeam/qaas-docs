<!-- generated hash:419870d14524 sources:Runner, functions, Configuration as Code, Collectors -->

# Collectors

Source-driven reference for `Runner` functions in the `Configuration as Code / Collectors` category.
