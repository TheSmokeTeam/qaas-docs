<!-- generated hash:eaf1bcbdee43 sources:Framework, functions, Utilities, Enumerables -->

# Enumerables

Source-driven reference for `Framework` functions in the `Utilities / Enumerables` category.
