<!-- generated hash:b9a5c89bda0c sources:Framework, functions, Configuration, Placeholders -->

# Placeholders

Source-driven reference for `Framework` functions in the `Configuration / Placeholders` category.
