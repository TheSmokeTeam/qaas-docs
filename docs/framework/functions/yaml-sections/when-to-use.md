---
id: framework.functions.yaml.sections.when.to.use
type: reference
status: stable
since: 2.0.0
...
summary: "Reference page for YAML: When to use."
---
...
> TL;DR — Reference page for YAML: When to use.

This page mirrors the `When to use` section from [YAML](../yaml.md).
