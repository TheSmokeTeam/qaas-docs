---
id: framework.functions.extension-methods-sections.extension-methods.configuration-update
type: reference
status: stable
since: 2.0.0
...
summary: "This page mirrors the Extension Methods / Configuration update section from Extension Methods."
---
