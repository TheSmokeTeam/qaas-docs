---
id: framework.functions.updates.sections.when.to.use
type: reference
status: stable
since: 2.0.0
...
summary: "Reference page for Updates: When to use."
---
<!-- Verified-against: QaaS.Framework\QaaS.Framework.Configurations\ConfigurationUpdateExtensions.cs -->

# Updates: When to use

> TL;DR — Reference page for Updates: When to use.

This page mirrors the `When to use` section from [Updates](../updates.md).
