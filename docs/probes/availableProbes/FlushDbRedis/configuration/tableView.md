---
id: probes.available.flushdbredis.configuration.tableview
slug: tableview
type: reference
status: stable
since: 2.0.0
...
code_langs: [yaml]
keywords: [probes, FlushDbRedis, configuration, reference]
ai_summary: "Field-by-field reference for FlushDbRedis ProbeConfiguration keys, types, defaults and descriptions, generated from probes.schema.json."
tags: [probes]
canonical_url: /probes/availableProbes/FlushDbRedis/configuration/tableView/
# Verified-against: QaaS.JsonSchemaExtensions/generated-schemas/probes.schema.json
---

# FlushDbRedis — Configuration (table view)
