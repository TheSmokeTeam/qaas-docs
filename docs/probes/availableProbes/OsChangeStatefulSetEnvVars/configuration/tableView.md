---
id: probes.availableprobes.oschangestatefulsetenvvars.configuration.tableview
type: reference
status: stable
since: 2.0.0
last_verified: 2026-05-22
applies_to: [probes]
keywords: [probes, availableprobes, oschangestatefulsetenvvars, configuration, tableview]
summary: "OsChangeStatefulSetEnvVars Configurations Table View"
---
