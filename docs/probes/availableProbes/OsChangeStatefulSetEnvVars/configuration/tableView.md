...
> TL;DR: Field-by-field reference for OsChangeStatefulSetEnvVars ProbeConfiguration keys, types, defaults and descriptions, generated from probes.schema.json.
