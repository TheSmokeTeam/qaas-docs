...
ai_summary: "Minimal YAML scaffold for DeleteRabbitMqExchanges ProbeConfiguration — copy, fill the blanks, drop into a Session step."
tags: [probes]
canonical_url: /probes/availableProbes/DeleteRabbitMqExchanges/configuration/yamlView/
