---
id: probes.available.osscalestatefulsetpods.configuration.tableview
type: reference
status: stable
since: 2.0.0
last_verified: 2026-05-22
applies_to: [probes]
keywords: [probes, OsScaleStatefulSetPods, configuration, reference]
summary: "Field-by-field reference for OsScaleStatefulSetPods ProbeConfiguration keys, types, defaults and descriptions, generated from probes.schema.json."
---
...
| `ProbeConfiguration.DesiredNumberOfPods` | `integer or string` | &#10004 |  | Number of replicas to set on the target Deployment or StatefulSet. Set it explicitly; there is no local range validation. |
