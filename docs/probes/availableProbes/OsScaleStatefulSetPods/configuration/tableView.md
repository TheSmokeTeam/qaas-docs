...
ai_summary: "Field-by-field reference for OsScaleStatefulSetPods ProbeConfiguration keys, types, defaults and descriptions, generated from probes.schema.json."
tags: [probes]
canonical_url: /probes/availableProbes/OsScaleStatefulSetPods/configuration/tableView/
# Verified-against: QaaS.JsonSchemaExtensions/generated-schemas/probes.schema.json
---

# OsScaleStatefulSetPods — Configuration (table view)
