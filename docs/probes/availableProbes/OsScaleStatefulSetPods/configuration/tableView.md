...
| `ProbeConfiguration.DesiredNumberOfPods` | `integer or string` | &#10004 |  | Number of replicas to set on the StatefulSet. Set it explicitly; there is no local range validation. |
