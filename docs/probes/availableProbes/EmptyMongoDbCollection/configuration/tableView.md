...
| `ProbeConfiguration.ChunkSize` | `integer or string or null` | &#10006 |  | Accepted from the shared MongoDB configuration shape but not used by this probe; the collection is deleted with one `DeleteMany` call. |
