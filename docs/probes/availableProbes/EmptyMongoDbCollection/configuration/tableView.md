...
applies_to: [probes]
prerequisites: [probes/availableProbes/EmptyMongoDbCollection/overview.md]
code_langs: [yaml]
keywords: [probes, EmptyMongoDbCollection, configuration, reference]
ai_summary: "Field-by-field reference for EmptyMongoDbCollection ProbeConfiguration keys, types, defaults and descriptions, generated from probes.schema.json."
tags: [probes]
canonical_url: /probes/availableProbes/EmptyMongoDbCollection/configuration/tableView/
# Verified-against: QaaS.JsonSchemaExtensions/generated-schemas/probes.schema.json
---

# EmptyMongoDbCollection — Configuration (table view)
