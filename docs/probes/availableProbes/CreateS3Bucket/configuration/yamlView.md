...
# CreateS3Bucket Configurations Yaml View

> TL;DR: Minimal YAML scaffold for CreateS3Bucket ProbeConfiguration — copy, fill the blanks, drop into a Session step.
