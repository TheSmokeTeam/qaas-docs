---
id: probes.available.osupdatedeploymentimage.configuration.tableview
type: reference
status: stable
since: 2.0.0
last_verified: 2026-05-22
applies_to: [probes]
keywords: [probes, OsUpdateDeploymentImage, configuration, reference]
summary: "Field-by-field reference for OsUpdateDeploymentImage ProbeConfiguration keys, types, defaults and descriptions, generated from probes.schema.json."
---
<!-- Verified-against: QaaS.JsonSchemaExtensions/generated-schemas/probes.schema.json -->

# OsUpdateDeploymentImage Configurations Table View

> TL;DR: Field-by-field reference for OsUpdateDeploymentImage ProbeConfiguration keys, types, defaults and descriptions, generated from probes.schema.json.
