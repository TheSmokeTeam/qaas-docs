...
ai_summary: "Field-by-field reference for OsUpdateDeploymentImage ProbeConfiguration keys, types, defaults and descriptions, generated from probes.schema.json."
tags: [probes]
canonical_url: /probes/availableProbes/OsUpdateDeploymentImage/configuration/tableView/
# Verified-against: QaaS.JsonSchemaExtensions/generated-schemas/probes.schema.json
---

# OsUpdateDeploymentImage — Configuration (table view)
