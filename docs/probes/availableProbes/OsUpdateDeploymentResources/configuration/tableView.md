...
| `ProbeConfiguration.DesiredResources` | `object or string` | &#10006 |  | Desired Deployment container requests and limits. Only `cpu` and `memory` are rebuilt by the implementation. |
