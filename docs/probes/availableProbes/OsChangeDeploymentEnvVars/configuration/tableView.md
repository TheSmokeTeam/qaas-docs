...
summary: "Field-by-field reference for OsChangeDeploymentEnvVars ProbeConfiguration keys, types, defaults and descriptions, generated from probes.schema.json."
---
<!-- Verified-against: QaaS.JsonSchemaExtensions/generated-schemas/probes.schema.json -->

# OsChangeDeploymentEnvVars Configurations Table View

> TL;DR: Field-by-field reference for OsChangeDeploymentEnvVars ProbeConfiguration keys, types, defaults and descriptions, generated from probes.schema.json.
