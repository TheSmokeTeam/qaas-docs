...
| `ProbeConfiguration.ContainerName` | `Null | String` | &#10006 |  | The name of the container we would like to update, if not given - the probe will update all of the pod's containers |
| `ProbeConfiguration.EnvVarsToUpdate` | `Object | String` | &#10006 |  | The environment variables to update/add |
...
| `ProbeConfiguration.EnvVarsToRemove` | `Array | String` | &#10006 |  | The environment variables to remove |
