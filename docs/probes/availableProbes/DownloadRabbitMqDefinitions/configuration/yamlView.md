...
summary: "Minimal YAML scaffold for DownloadRabbitMqDefinitions ProbeConfiguration — copy, fill the blanks, drop into a Session step."
---
<!-- Verified-against: QaaS.JsonSchemaExtensions/generated-schemas/probes.schema.json -->

# DownloadRabbitMqDefinitions Configurations Yaml View

> TL;DR: Minimal YAML scaffold for DownloadRabbitMqDefinitions ProbeConfiguration — copy, fill the blanks, drop into a Session step.
