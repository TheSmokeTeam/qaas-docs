...
> TL;DR: Field-by-field reference for OsUpdateStatefulSetResources ProbeConfiguration keys, types, defaults and descriptions, generated from probes.schema.json.
