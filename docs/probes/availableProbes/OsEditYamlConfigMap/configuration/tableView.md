...
| `ProbeConfiguration.ValuesToEdit` | `object or string` | &#10006 |  | JSONPath-to-value map applied after the YAML is converted to JSON. Missing paths are logged as warnings and skipped. |
