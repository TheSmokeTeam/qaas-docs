...
| `ProbeConfiguration.BatchSize` | `Integer | String` | &#10006 | 100 | Batch Size to do the operation on |
...
| `ProbeConfiguration.KeyRegexPattern` | `Null | String` | &#10006 |  | Optional regex used to filter which redis keys should be deleted |
