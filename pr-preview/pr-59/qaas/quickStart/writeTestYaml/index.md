...
The completed sample is available at [DummyAppTests (YAML)](https://github.com/TheSmokeTeam/DummyAppTests/tree/yaml_configuration).
...
[MetaData](https://TheSmokeTeam.github.io/qaas-docs/qaas/userInterfaces/runner/configurationSections/metaData/overview/index.md) makes the run easier to identify later in reports. [DataSources](https://TheSmokeTeam.github.io/qaas-docs/qaas/userInterfaces/runner/configurationSections/dataSources/overview/index.md) says: "load the test payloads from the local `TestData` folder."
...
The [Publisher](https://TheSmokeTeam.github.io/qaas-docs/qaas/userInterfaces/runner/configurationSections/sessions/types/publishers/index.md) sends every payload loaded by `FromFileSystemTestData` to the `dummy-app-tests-input` exchange. The [Consumer](https://TheSmokeTeam.github.io/qaas-docs/qaas/userInterfaces/runner/configurationSections/sessions/types/consumers/index.md) listens on the `dummy-app-tests-output` exchange, waits up to five seconds, and deserializes the received body as JSON. In a real test, your application or local quick-start environment should move the message from `dummy-app-tests-input` to `dummy-app-tests-output`.
...
`HermeticByInputOutputPercentage` from [QaaS.Common.Assertions](https://TheSmokeTeam.github.io/qaas-docs/assertions/index.md) checks that every input produced a matching output. `DelayByChunks` from [QaaS.Common.Assertions](https://TheSmokeTeam.github.io/qaas-docs/assertions/index.md) checks that the output arrives within ten seconds.
