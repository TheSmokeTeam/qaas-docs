...
`QaaS.Framework.Configurations` is the Framework solution's configuration engine. It is a standalone package that other QaaS packages reference, including [QaaS.Framework.SDK](https://TheSmokeTeam.github.io/qaas-docs/framework/projects/sdk/index.md). Its responsibility is broader than loading YAML into C# objects. It owns the full flow of building configuration, preprocessing it, binding it, validating it, and updating it.
