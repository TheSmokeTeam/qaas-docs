...
> TL;DR: Field-by-field reference for DeleteRabbitMqVirtualHosts ProbeConfiguration keys, types, defaults and descriptions, generated from probes.schema.json.
...
| `ProbeConfiguration.VirtualHostNames`               | `list or string`       | ✔        |         | The rabbitmq virtual host names to delete                                                                                                |
| `ProbeConfiguration.VirtualHostNames[]`             | `string`               | ✖        |         |                                                                                                                                          |
