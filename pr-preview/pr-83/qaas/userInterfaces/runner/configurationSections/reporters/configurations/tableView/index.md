...
| `Reporters.SaveTerminalOutput`       | `string or true/false or null` | ✖        | True                                                                       | Whether to capture all terminal output from the entire QaaS execution, including output not emitted through the context logger, and save it once per launch as a terminal.log attachment. |
