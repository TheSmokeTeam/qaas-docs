...
When the built-in [Plugins](https://TheSmokeTeam.github.io/qaas-docs/qaas/addOns/plugins/index.md) and packaged hooks do not provide sufficient functionality for your test requirements, custom hooks can be implemented in a C# project to extend [QaaS.Framework](https://TheSmokeTeam.github.io/qaas-docs/framework/index.md). This guide demonstrates how to create and integrate custom [QaaS.Common.Generators](https://TheSmokeTeam.github.io/qaas-docs/generators/index.md), [QaaS.Common.Assertions](https://TheSmokeTeam.github.io/qaas-docs/assertions/index.md), and [QaaS.Common.Probes](https://TheSmokeTeam.github.io/qaas-docs/probes/index.md) style hooks to test a specific condition:
...
A generator produces test data for [DataSources](https://TheSmokeTeam.github.io/qaas-docs/qaas/userInterfaces/runner/configurationSections/dataSources/overview/index.md) and implements the `IGenerator` interface from the `QaaS.Framework.SDK` package. We extend `BaseGenerator<T>` with a configuration record that includes validation and default values.
...
Define a [DataSource](https://TheSmokeTeam.github.io/qaas-docs/qaas/userInterfaces/runner/configurationSections/dataSources/overview/index.md) in `test.qaas.yaml` that uses the custom generator with specific configuration.
...
Create a new [Session](https://TheSmokeTeam.github.io/qaas-docs/qaas/userInterfaces/runner/configurationSections/sessions/overview/index.md) that uses the `10Samples` data source. Since the data is JSON, a `Serializer` must be configured.
...
Apply standard [QaaS.Common.Assertions](https://TheSmokeTeam.github.io/qaas-docs/assertions/index.md) to the new session for hermeticity and delay.
...
To verify that output JSON arrays have the expected length, implement a custom assertion in the same style as [QaaS.Common.Assertions](https://TheSmokeTeam.github.io/qaas-docs/assertions/index.md).
...
- [Assertions authoring guide](https://TheSmokeTeam.github.io/qaas-docs/assertions/custom-authoring-guide/index.md)
- [Generators authoring guide](https://TheSmokeTeam.github.io/qaas-docs/generators/custom-authoring-guide/index.md)
- [Probes authoring guide](https://TheSmokeTeam.github.io/qaas-docs/probes/custom-authoring-guide/index.md)
- [Processors authoring guide](https://TheSmokeTeam.github.io/qaas-docs/processors/custom-authoring-guide/index.md)
- [Framework SDK](https://TheSmokeTeam.github.io/qaas-docs/framework/projects/sdk/index.md)
