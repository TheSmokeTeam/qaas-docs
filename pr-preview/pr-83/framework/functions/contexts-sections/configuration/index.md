...
> TL;DR — This page mirrors the `Configuration` section from [Contexts](https://TheSmokeTeam.github.io/qaas-docs/framework/functions/contexts/index.md) as a focused reference.
...
**Member** `ContextBuilder.SetConfigurationFile(string? configurationFile)`
...
**Member** `ContextBuilder.WithOverwriteFile(string? overwriteFile)`
...
**Member** `ContextBuilder.WithOverwriteFolder(string? overwriteFolder)`
...
**Member** `ContextBuilder.SetCase(string? caseFile)`
...
**Member** `ContextBuilder.WithOverwriteArgument(string? argument)`
...
**Member** `ContextBuilder.WithReferenceResolution(ReferenceConfig referenceConfig)`
...
**Member** `ContextBuilder.WithEnvironmentVariableResolution()`
