...
| `ProbeConfiguration.Command`            | `string`                 | ✔        |         | The redis command to execute                                                                                                             |
...
| `ProbeConfiguration.StoreResultAs`      | `string or null`         | ✖        |         | Optional alias used to store the command result for later redisResults placeholders                                                      |
...
| `ProbeConfiguration.Arguments`          | `list or string or null` | ✖        |         | Optional redis command arguments                                                                                                         |
| `ProbeConfiguration.Arguments[]`        | `string`                 | ✖        |         |                                                                                                                                          |
...
- [YAML scaffold](https://TheSmokeTeam.github.io/qaas-docs/probes/availableProbes/ExecuteRedisCommand/configuration/yamlView/index.md)
- [Overview](https://TheSmokeTeam.github.io/qaas-docs/probes/availableProbes/ExecuteRedisCommand/overview/index.md)
