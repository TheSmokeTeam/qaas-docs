...
| `ProbeConfiguration.Permissions`                    | `list or string`       | ✔        |         | The rabbitmq permission targets to delete                                                                                                |
...
- [YAML scaffold](https://TheSmokeTeam.github.io/qaas-docs/probes/availableProbes/DeleteRabbitMqPermissions/configuration/yamlView/index.md)
- [Overview](https://TheSmokeTeam.github.io/qaas-docs/probes/availableProbes/DeleteRabbitMqPermissions/overview/index.md)
