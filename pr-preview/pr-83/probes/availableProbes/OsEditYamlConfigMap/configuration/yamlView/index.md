...
ProbeConfiguration:
  ConfigMapName: 'value'
  ConfigMapYamlFileName: 'ConfigMap.yml'
  UseGlobalDict: False
  ValuesToEdit: {}
  Openshift:
    Cluster: 'value'
...
- [Configuration table](https://TheSmokeTeam.github.io/qaas-docs/probes/availableProbes/OsEditYamlConfigMap/configuration/tableView/index.md)
