...
The completed sample is available at [DummyAppMock (Code)](https://github.com/TheSmokeTeam/DummyAppMock/tree/code_configuration).
...
- [Mocker functions](https://TheSmokeTeam.github.io/qaas-docs/mocker/functions/index.md)
