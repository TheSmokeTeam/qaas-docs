...
| `ProbeConfiguration.DesiredImage`                             | `string`               | ✔        |         | The desired image to update the container to                                                                                                                                                                                       |
...
- [Overview](https://TheSmokeTeam.github.io/qaas-docs/probes/availableProbes/OsUpdateStatefulSetImage/overview/index.md)
