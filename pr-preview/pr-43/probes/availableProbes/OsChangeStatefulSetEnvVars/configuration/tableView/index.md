...
| `ProbeConfiguration.ContainerEnvVarsToUpdate`                 | `object or string or null` | ✖        |         | Optional exact environment snapshot keyed by container name. When present, the probe restores each listed container to the provided environment instead of applying the broad update/remove rules.                                 |
| `ProbeConfiguration.ContainerName`                            | `string or null`           | ✖        |         | The name of the container we would like to update, if not given - the probe will update all of the pod's containers                                                                                                                |
| `ProbeConfiguration.EnvVarsToUpdate`                          | `object or string`         | ✖        |         | The environment variables to update/add                                                                                                                                                                                            |
...
| `ProbeConfiguration.EnvVarsToRemove`                          | `list or string`           | ✖        |         | The environment variables to remove                                                                                                                                                                                                |
| `ProbeConfiguration.EnvVarsToRemove[]`                        | `string`                   | ✖        |         |                                                                                                                                                                                                                                    |
...
- [YAML scaffold](https://TheSmokeTeam.github.io/qaas-docs/probes/availableProbes/OsChangeStatefulSetEnvVars/configuration/yamlView/index.md)
- [Overview](https://TheSmokeTeam.github.io/qaas-docs/probes/availableProbes/OsChangeStatefulSetEnvVars/overview/index.md)
