...
def main() -> int:
    ...
    defaults = {
        ...
        "image_dotnet_sdk": resolve_value("QAAS_DOCS_IMAGE_DOTNET_SDK", "mcr.microsoft.com/dotnet/sdk:10.0"),
        "image_dotnet_runtime": resolve_value("QAAS_DOCS_IMAGE_DOTNET_RUNTIME", "mcr.microsoft.com/dotnet/runtime:10.0"),
        "image_redis_repository": resolve_value("QAAS_DOCS_IMAGE_REDIS_REPOSITORY", "redis"),
        "image_redis_tag": resolve_value("QAAS_DOCS_IMAGE_REDIS_TAG", "7-alpine"),
    }
